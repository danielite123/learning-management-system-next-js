  ...
  return (
    <div className="flex justify-center py-[20px]">
      <div className="flex justify-center flex-wrap gap-[40px]">
        <div className="w-[500px] h-[600px] rounded-xl bg-[url('/images/register.png')] bg-cover hidden lg:block"></div>
        <div className="lg:w-[500px] lg:px-0 px-[150px] w-full h-[600px] max-sm:px-[120px">
          <div className="w-[300px] h-[500px] flex flex-col justify-center gap-6 m-auto my-[50px]">
